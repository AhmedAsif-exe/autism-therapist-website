    ...
    <div className="relative ">
      <div className="flex flex-col items-center t:flex-row l:justify-around justify-between items-start md:items-center min-h-screen px-10  xl:px-20 pt-28 bg-white rounded-b-[50%] max-w-[1440px] mx-auto">
        <div className="flex flex-col items-start max-w-full t:max-w-[45%] l:max-w-[50%] z-10 font-raleway">
          ...
          >
            Welcome to Aba Virtual
          </h1>
          <p
            id="para2"
            className="opacity-0 translate-y-5 mm:text-[18px] text-[14px] font-light pb-2 text-left m-0 font-inter"
          >
            A learning journey that offers ease, flexibility, and a clear sense
            of structure to support growth and independence.
          </p>
          <div
            id="button"
          ...
          >
            <a
              className="bg-[#265c7e] text-white text-[20px] px-5 py-2 rounded shadow-md font-londrina min-w-[150px]"
              href="#process-section"
            >
              Discover More
            </a>
            <a
              className="border-2 border-[#f97544] text-[#f97544] text-[20px] px-5 py-2 rounded font-londrina min-w-[150px]"
              href="/contact"
            >
              Contact
            </a>
