...
export function Game5() {
        ...
        showRound() {
          if (this.roundIndex >= this.rounds.length) {
            ...
            import('Utils/ProgressTracker').then(({ recordSession }) => {
              recordSession(5, this.perfectRounds).catch(error => {
                console.error('Error saving score for Game 5:', error);
              });
            });
      ...
      class SummaryScene extends PhaserGame.Scene {
        ...
        async init(data) {
          ...
          try {
            ...
            this.history = await getLastNSessions(5, 20);
          } catch (e) {
  ...
  if (checking) return <GameLoadingScreen gameTitle="Class Match" />;
